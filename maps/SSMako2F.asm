...
Fangirl2FTeleport1:
	...
	faceobject SSMAKO2F_FANGIRL, PLAYER
	end
...
SSMako2F_MapEvents:
	...
	db 3 ; object events
	object_event 23, -2, SPRITE_FANGIRL, SPRITEMOVEDATA_COMPANION, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, SSMako2FFangirl, -1
	object_event 15,  7, SPRITE_RECEPTIONIST, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, SSMako2FReceptionist, -1
	object_event 17,  4, SPRITE_OFFICER_M, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, SSMako2FOfficer, EVENT_SS_MAKO_DEFEATED_BURGLAR
