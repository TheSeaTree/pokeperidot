...
PectiniaApartmentLeft_MapEvents:
	...
	db 4 ; object events
	object_event  2,  2, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, PectiniaApartmentLeftGuard1Script, -1
	object_event  6,  1, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, PectiniaApartmentLeftGuard2Script, EVENT_AZALEA_RETURNED_BIKE
