	...
	const TRADECENTER_PERRY1
	const TRADECENTER_PERRY2
...
.SetWhichSide:
	...
	iffalse .Chris2
	disappear TRADECENTER_PERRY2
	appear TRADECENTER_PERRY1
	return

.Chris2:
	disappear TRADECENTER_PERRY1
	appear TRADECENTER_PERRY2
	return
