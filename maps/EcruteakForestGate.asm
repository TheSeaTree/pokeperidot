...
EcruteakForestGate_MapEvents:
	...
	object_event  8,  6, SPRITE_TEACHER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, EcruteakForestGateTeacher, -1
