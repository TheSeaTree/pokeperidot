...
Route16_MapEvents:
	...
	db 5 ; bg events
	bg_event 11, 32, BGEVENT_READ, Route16Sign
	bg_event 43, 25, BGEVENT_READ, Route16TrainerTipSign
	bg_event 55, 22, BGEVENT_ITEM, Route16HiddenNugget
	bg_event  7, 30, BGEVENT_ITEM, Route16HiddenXSpeed
	bg_event  8, 19, BGEVENT_ITEM, Route16HiddenSunStone

	db 9 ; object events
	object_event 28, 16, SPRITE_BIG_SNORLAX, SPRITEMOVEDATA_BIGDOLLSYM, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route16SnorlaxEvent, EVENT_FOUGHT_SNORLAX
	...
	object_event 29, 11, SPRITE_TEACHER, SPRITEMOVEDATA_WANDER, 2, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, Route16Teacher, -1
	object_event 43, 22, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route16FruitTree1, -1
	object_event  6, 19, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route16FruitTree2, -1
	object_event 25, 23, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route16PoisonBarb, EVENT_ROUTE_16_POISON_BARB
