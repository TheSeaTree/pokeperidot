...
SeaRoute1_MapEvents:
	...
	db 9 ; object events
	object_event  5, 11, SPRITE_FISHER, SPRITEMOVEDATA_STANDING_DOWN, 0, 1, -1, -1, 0, OBJECTTYPE_TRAINER, 1, TrainerFisherStan, -1
	object_event 17,  7, SPRITE_FISHER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 1, -1, -1, 0, OBJECTTYPE_TRAINER, 1, TrainerFisherCody, -1
	object_event 12, 21, SPRITE_FISHER, SPRITEMOVEDATA_STANDING_LEFT, 0, 1, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, SeaRoute1Fisher, -1
	object_event 18, 26, SPRITE_SAILOR, SPRITEMOVEDATA_STANDING_DOWN, 0, 1, -1, -1, 0, OBJECTTYPE_TRAINER, 2, TrainerSailorTucker, -1
	object_event  9, 16, SPRITE_SWIMMER_GIRL, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 1, -1, -1, 0, OBJECTTYPE_TRAINER, 3, TrainerSwimmerLaurie, -1
	object_event 18, 14, SPRITE_SWIMMER_GUY, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 1, -1, -1, 0, OBJECTTYPE_TRAINER, 3, TrainerSwimmerHarley, -1
	object_event 26,  8, SPRITE_SWIMMER_GIRL, SPRITEMOVEDATA_STANDING_DOWN, 0, 1, -1, -1, 0, OBJECTTYPE_TRAINER, 4, TrainerSwimmerSandra, -1
	object_event 33, 12, SPRITE_SWIMMER_GUY, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 1, -1, -1, 0, OBJECTTYPE_TRAINER, 3, TrainerSwimmerRussel, -1
	object_event 10, 29, SPRITE_SWIMMER_GIRL, SPRITEMOVEDATA_STANDING_RIGHT, 0, 1, -1, -1, 0, OBJECTTYPE_TRAINER, 3, TrainerSwimmerBrett, -1
