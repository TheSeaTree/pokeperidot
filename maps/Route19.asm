...
Route19_MapEvents:
	...
	object_event 24, 21, SPRITE_POKE_BALL, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route19Thunderstone, EVENT_ROUTE_15_THUNDERSTONE
	object_event 32,  6, SPRITE_POKE_BALL, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route19Calcium, EVENT_ROUTE_15_CALCIUM
