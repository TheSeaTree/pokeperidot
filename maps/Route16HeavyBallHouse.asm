Route16HeavyBallHouse_MapScripts:
	db 0 ; scene scripts
...
Route16HeavyBallHouse_MapEvents:
	db 0, 0 ; filler
	...
	db 1 ; object events
	object_event  2,  4, SPRITE_POKEFAN_M, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Route16HeavyBallGuy, -1
