...
AcroporaCity_MapEvents:
	...
	db 10 ; warp events
	warp_event 33, 13, ROUTE_16_ACROPORA_GATE, 3
	...
	object_event 30, 26, SPRITE_BIKER, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 1, 2, -1, -1, 0, OBJECTTYPE_SCRIPT, 4, AcroporaBikerScript, EVENT_CLEARED_BURGLAR_HIDEOUT
