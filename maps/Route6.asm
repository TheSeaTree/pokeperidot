...
Route6_MapEvents:
	...
	warp_event  0, 13, TIDAL_PASS_1F, 1
	...
	object_event 18,  6, SPRITE_BUENA, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_PURPLE, OBJECTTYPE_SCRIPT, 0, Route6LassScript, EVENT_ROAMING_BIRDS
