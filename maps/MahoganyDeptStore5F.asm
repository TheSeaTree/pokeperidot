...
MahoganyDeptStore5FDollClerkScript:
	faceplayer
	opentext
	writetext MahoganyDeptStore5FDollClerkIntro
.Page1
...
.Page2
	...
	jump .Page1
.Goodbye
	writetext MahoganyDeptStore5FGoodbye
	waitbutton
	closetext
	end
...
.Pikachu
	...
	writetext MahoganyDeptStore5FDollClerkConfirm
	yesorno
...
.Confirm
	writetext MahoganyDeptStore5FShippedToHome
	jump .Page1
	
.NotEnoughMoney:
	writetext MahoganyDeptStore5FNotEnough
	waitbutton
	jump .SomethingElse
	
.AlreadyHave:
	writetext MahoganyDeptStore5FAlreadyHave
	waitbutton
	
.SomethingElse:
	writetext MahoganyDeptStore5FSomethingElse
	jump .Page1
...
MahoganyDeptStore5FConsoleClerkScript:
	faceplayer
	opentext
	writetext MahoganyDeptStore5FConsoleClerkIntro
.Start
	special PlaceMoneyTopRight
	loadmenu .MenuHeader
	verticalmenu
...
.SNES
	writetext MahoganyDeptStore5SNESConfirm
	yesorno
	iffalse .SomethingElse
...
.N64
	writetext MahoganyDeptStore5N64Confirm
	yesorno
	iffalse .SomethingElse
...
.VirtualBoy
	writetext MahoganyDeptStore5VirtualBoyConfirm
	yesorno
	iffalse .SomethingElse
	checkmoney YOUR_MONEY, 20000
	ifequal HAVE_LESS, .NotEnoughMoney
...
DeptStoreGenericDoll:	
	writetext MahoganyDeptStore5FDollText
	waitbutton
	closetext
	end
	
DeptStoreSNES:
	jumptext MahoganyDeptStoreSNESText

DeptStoreN64:
	jumptext MahoganyDeptStoreN64Text

DeptStoreVirtualBoy:
	jumptext MahoganyDeptStoreVirtualBoyText
	
MahoganyDeptStore5FLassScript:
	jumptextfaceplayer MahoganyDeptStore5FLassText

MahoganyDeptStore5FYoungsterScript:
	jumptextfaceplayer MahoganyDeptStore5FYoungsterText
...
MahoganyDeptStore5FDollClerkIntro:
	text "Welcome to the"
	line "DOLL SHOP."
...
MahoganyDeptStore5FDollClerkConfirm:
...
MahoganyDeptStore5FShippedToHome:
...
MahoganyDeptStore5FAlreadyHave:
	text "Hm…"
...
MahoganyDeptStore5FConsoleClerkIntro:
	text "Welcome to the"
	line "CONSOLE CORNER!"
...
MahoganyDeptStore5SNESConfirm:
	text "You would like the"
	line "SNES?"
	done

MahoganyDeptStore5N64Confirm:
	text "You would like the"
	line "N64?"
	done

MahoganyDeptStore5VirtualBoyConfirm:
	text "You would like the"
	line "VIRTUAL BOY?"
	done
	
MahoganyDeptStore5FNotEnough:
	text "You can't afford"
	line "that item right"
	cont "now. Sorry…"
	done
	
MahoganyDeptStore5FSomethingElse:
	text "Did you want some-"
	line "thing else?"
	done
	
MahoganyDeptStore5FGoodbye:
	text "OK! We hope to see"
	line "you again!"
	done

MahoganyDeptStore5FDollText:
...
MahoganyDeptStoreN64Text:
	text "This game shows a"
	line "female spy with an"
	cont "alien!"
	done
	
MahoganyDeptStoreVirtualBoyText:
...
MahoganyDeptStore5FYoungsterText:
...
MahoganyDeptStore5F_MapEvents:
	...
	db 13 ; object events
	object_event  7,  5, SPRITE_CLERK, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, MahoganyDeptStore5FDollClerkScript, -1
	object_event  8,  5, SPRITE_CLERK, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, MahoganyDeptStore5FConsoleClerkScript, -1
	object_event  4,  6, SPRITE_LASS, SPRITEMOVEDATA_WANDER, 1, 2, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, MahoganyDeptStore5FLassScript, -1
	object_event 15,  5, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, MahoganyDeptStore5FYoungsterScript, -1
