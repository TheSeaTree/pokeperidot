...
.AfterBattle
	...
	moveobject WILBURSROOM_WILBUR, 8, 10
	appear WILBURSROOM_WILBUR
	end
...
WilbursRoom_MapEvents:
	...
	object_event 11, 10, SPRITE_BOMB, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_TEMPORARY_UNTIL_MAP_RELOAD_1
	object_event  0,  0, SPRITE_SHADOW, SPRITEMOVEDATA_SPRITE_SHADOW, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_TEMPORARY_UNTIL_MAP_RELOAD_1
