...
Route24HiddenCaveB1F_MapEvents:
	...
	db 3 ; object events
	object_event 33, 19, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route24HiddenCaveB1FPPUp, EVENT_ROUTE_18_CAVE_B1F_PP_UP
	object_event 37, 25, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route24HiddenCaveB1FMetalCoat, EVENT_ROUTE_18_CAVE_B1F_METAL_COAT
	object_event  4,  9, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route24HiddenCaveB1FFullRestore, EVENT_ROUTE_18_CAVE_B1F_FULL_RESTORE
