	...
	const ROUTE14FARMHOUSE_DAD
	const ROUTE14FARMHOUSE_MOM
	const ROUTE14FARMHOUSE_GRAMPS

Route14Farmhouse_MapScripts:
	db 2 ; scene scripts
...
.Default
	disappear ROUTE14FARMHOUSE_GRAMPS
.Done
	end

Route14FarmhouseMother:
	faceplayer
	opentext
	checkevent EVENT_MARIE_GONE_HOME
	iftrue .SellMilk
	writetext Route14FarmhouseMotherMarieNotHomeText
	waitbutton
	closetext
	end
...
Route14FarmhouseFather:
	checkevent EVENT_MARIE_GONE_HOME
	iffalse .NotHome
	jumptextfaceplayer Route14FarmhouseFatherHomeText 
	
.NotHome
	jumptextfaceplayer Route14FarmhouseFatherAwayText

Route14FarmhouseGrandpa:
	jumptextfaceplayer Route14FarmhouseGrandpaText
	
Route14FarmhouseMotherMarieNotHomeText:
...
Route14FarmhouseFatherHomeText:
...
Route14FarmhouseFatherAwayText:
...
Route14Farmhouse_MapEvents:
	db 0, 0 ; filler

	db 2 ; warp events
	warp_event  3,  7, ROUTE_14, 6
	warp_event  4,  7, ROUTE_14, 6
	...
	db 3 ; object events 
	object_event  2,  3, SPRITE_POKEFAN_M, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route14FarmhouseFather, -1
	object_event  5,  4, SPRITE_POKEFAN_F, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route14FarmhouseMother, -1
	object_event  4,  2, SPRITE_GRAMPS, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, Route14FarmhouseGrandpa, -1
