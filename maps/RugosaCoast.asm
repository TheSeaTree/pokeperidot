...
RugosaCoast_MapEvents:
	...
	db 13 ; object events
	object_event 22, 11, SPRITE_SAILOR, SPRITEMOVEDATA_WALK_UP_DOWN, 0, 1, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, RugosaCoastSailor1Script, -1
	object_event 21, 16, SPRITE_YOUNGSTER, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, RugosaCoastStandingYoungsterScript, -1
	...
	object_event 25, 24, SPRITE_OLIVINE_RIVAL, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, RugosaCoastMoveTutor, -1 ; Icy Wind tutor
