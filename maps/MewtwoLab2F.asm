...
MewtwoLab2F_MapEvents:
	...
	object_event 16, 10, SPRITE_PAPER, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_ITEMBALL, 0, MewtwoLab2FOldSeaMap, EVENT_FOUND_OLD_SEA_MAP
