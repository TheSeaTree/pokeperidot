...
AzaleaApartmentRight_MapEvents:
	...
	warp_event  5, 0, AZALEA_APARTMENT_RIGHT_2F,  1
	...
	object_event  5,  1, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, AzaleaApartmentRightGuard2Script, EVENT_AZALEA_RETURNED_BIKE
	object_event  7,  5, SPRITE_BUENA, SPRITEMOVEDATA_WANDER, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, AzaleaApartmentRightBuenaScript, EVENT_AZALEA_RETURNED_BIKE
