	...
	const ROUTE11_CLEANSE_TAG_GUY

Route11CleanseTagHouse_MapScripts:
	db 0 ; scene scripts

	db 0 ; callbacks

Route11CleanseTagScript:
	faceplayer
	opentext
...
Route11CleanseTagHouse_MapEvents:
	db 0, 0 ; filler
	...
	db 1 ; object events
	object_event  5,  3, SPRITE_GRAMPS, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, Route11CleanseTagScript, -1
