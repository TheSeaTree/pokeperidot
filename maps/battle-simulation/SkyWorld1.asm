...
SkyWorld1_MapEvents:
	...
	object_event 14,  6, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 1, 1, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, BattleSimSky1Itemball1, EVENT_TEMPORARY_UNTIL_MAP_RELOAD_4
