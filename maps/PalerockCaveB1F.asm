...
PalerockCaveB1F_MapEvents:
	...
	object_event  5, 25, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, PalerockCaveB1FIron, EVENT_ROCK_TUNNEL_B1F_IRON
	...
	object_event  3, 21, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, PalerockCaveB1FRevive, EVENT_ROCK_TUNNEL_B1F_REVIVE
