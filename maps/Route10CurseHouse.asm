	...
	const ROUTE10CURSEHOUSE_MEDIUM
	const ROUTE10CURSEHOUSE_ITEMBALL

Route10CurseHouse_MapScripts:
	db 0 ; scene scripts
...
.Medium:
	...
	iftrue .DoNothing
	moveobject ROUTE10CURSEHOUSE_MEDIUM,  -3, -3
.DoNothing:
	return
...
TrainerMediumAnnabel:
	...
	disappear ROUTE10CURSEHOUSE_MEDIUM
	setevent EVENT_HIDE_MEDIUM_ANNABELLE
	moveobject ROUTE10CURSEHOUSE_ITEMBALL, 3, 3
	appear ROUTE10CURSEHOUSE_ITEMBALL
	wait 8
...
Route10CurseHouse_MapEvents:
	db 0, 0 ; filler

	db 2 ; warp events
	warp_event  3,  7, ROUTE_10, 4
	warp_event  4,  7, ROUTE_10, 4
