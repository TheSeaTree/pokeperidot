...
HepaticaLugiaSpeechHouse_MapEvents:
	...
	object_event  5,  3, SPRITE_POKEFAN_M, SPRITEMOVEDATA_STILL, 2, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, HepaticaLugiaSpeechHouseHikerScript, EVENT_CIANWOOD_FLY_GUY
