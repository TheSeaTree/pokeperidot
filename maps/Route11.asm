...
Route11_MapEvents:
	...
	db 3 ; bg events
	bg_event 48,  6, BGEVENT_READ, Route11ShelterSign
	bg_event 54, 21, BGEVENT_ITEM, Route11HiddenFreshWater
	bg_event 25,  5, BGEVENT_ITEM, Route11HiddenSuperRepel
	...
	object_event 56,  4, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route11FruitTree, -1
	object_event 65,  8, SPRITE_BUSH, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route11ItemBush, -1
	object_event  5,  3, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route11FireStone, EVENT_ROUTE_11_FIRE_STONE
