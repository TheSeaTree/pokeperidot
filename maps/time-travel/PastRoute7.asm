...
PastRoute7_MapEvents:
	...
	db 3 ; bg events
	bg_event  4,  5, BGEVENT_ITEM, PastRoute7HiddenLeafStone
	bg_event 27, 14, BGEVENT_ITEM, PastRoute7HiddenBigMushroom
	bg_event 30,  0, BGEVENT_ITEM, PastRoute7HiddenKingsRock
	...
	object_event 13, 14, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, PastRoute7GlowScales, EVENT_ROUTE_7_PAST_GLOW_SCALES
	object_event 12, 21, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, PastRoute7SodaPop, EVENT_ROUTE_7_PAST_SODA_POP
