...
PastRoute11Schoolhouse_MapEvents:
	...
	db 8 ; object events
	object_event  5,  3, SPRITE_GYM_GUY, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, 0, 0, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, PastRoute11SchoolhouseTeacher, -1
	...
	object_event  2,  7, SPRITE_LASS, SPRITEMOVEDATA_STANDING_UP, 0, 0, 0, 0, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, TrainerLassJean, -1
	...
	object_event  4,  5, SPRITE_TWIN, SPRITEMOVEDATA_STANDING_UP, 0, 0, 0, 0, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, PastRoute11SchoolhouseTwin, -1
	...
	object_event  8,  7, SPRITE_LASS, SPRITEMOVEDATA_STANDING_UP, 0, 0, 0, 0, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, TrainerPicnickerGia, -1
