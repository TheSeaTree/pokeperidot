...
PastRoute11Schoolhouse_MapEvents:
	...
	db 1 ; bg events
	bg_event 20, 10, BGEVENT_UP, PastRoute11SchoolhouseEmptyDesk

	db 8 ; object events
	object_event  5,  3, SPRITE_TEACHER, SPRITEMOVEDATA_STANDING_DOWN, 1, 0, 7, 15, PAL_NPC_PURPLE, OBJECTTYPE_SCRIPT, 0, ObjectEvent, -1
