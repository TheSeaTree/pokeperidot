...
HepaticaMart_MapEvents:
	...
	object_event  2,  5, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, HepaticaMartYoungsterScript, EVENT_CIANWOOD_FLY_GUY
