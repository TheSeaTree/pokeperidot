...
EcruteakFriendBallHouse_MapScripts:
	db 0 ; scene scripts

	db 0 ; callbacks
	
EcruteakFriendBallMerchant:
	faceplayer
	opentext
...
EcruteakFriendBallHouse_MapEvents:
	db 0, 0 ; filler

	db 2 ; warp events
	warp_event  2,  7, ECRUTEAK_CITY, 8
	warp_event  3,  7, ECRUTEAK_CITY, 8
	...
	db 2 ; object events
	object_event  2,  3, SPRITE_LASS, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, EcruteakFriendBallMerchant, -1
