	...
	const ROUTE8LEAFTRADER_POKEFANF

Route8LeafTrader_MapScripts:
	db 0 ; scene scripts
...
Route8SilkScarfLadyAfterText
	...
	line "for a lovely little"
	cont "TEDDIURSA!"
	done

Route8LeafTrader_MapEvents:
	db 0, 0 ; filler
	...
	db 1 ; object events
	object_event  2,  4, SPRITE_POKEFAN_F, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, Route8SilkScarfLadyTrader, -1
