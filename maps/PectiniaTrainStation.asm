...
PectiniaTrainStationOfficerScript:
	faceplayer
	opentext
...
.MagnetTrainToSaffron:
	...
	waitbutton
	closetext
	applymovement PECTINIATRAINSTATION_OFFICER, MovementData_0x55146
...
Script_ArriveFromSaffron:
	...
	applymovement PECTINIATRAINSTATION_OFFICER, MovementData_0x5514b
	opentext
...
PectiniaTrainStationGentlemanScript:
	jumptextfaceplayer PectiniaTrainStationGentlemanText
...
PectiniaTrainStationGentlemanText:
...
PectiniaTrainStation_MapEvents:
	...
	db 2 ; object events
	object_event  9,  5, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, PectiniaTrainStationOfficerScript, -1
	object_event 10, 13, SPRITE_GENTLEMAN, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, PectiniaTrainStationGentlemanScript, EVENT_GOLDENROD_TRAIN_STATION_GENTLEMAN
