...
CianwoodLugiaSpeechHouse_MapEvents:
	...
	object_event  5,  3, SPRITE_POKEFAN_M, SPRITEMOVEDATA_STILL, 2, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, CianwoodLugiaSpeechHouseHikerScript, EVENT_CIANWOOD_FLY_GUY ; note explaining that she's at the church to see what's going on
