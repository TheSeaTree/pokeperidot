...
; entries correspond to FISHGROUP_* constants
	fishgroup 50 percent + 1, .No_Encounter,	.Shore_Good,	.Shore_Super
	fishgroup 50 percent + 1, .No_Encounter,	.Ocean_Good,	.Ocean_Super
	fishgroup 50 percent + 1, .No_Encounter,	.Lake_Good,		.Lake_Super
	fishgroup 50 percent + 1, .No_Encounter,	.Pond_Good,		.Pond_Super
	fishgroup 50 percent + 1, .No_Encounter,	.Safari_Good,	.Safari_Super
	fishgroup 50 percent + 1, .No_Encounter,	.Past_Good,		.Past_Super
	fishgroup 50 percent + 1, .No_Encounter,	.Past_2_Good,	.Past_2_Super
	fishgroup 50 percent + 1, .No_Encounter,	.Past_3_Good,	.Past_3_Super
	fishgroup 50 percent + 1, .No_Encounter,	.Grimer_Good,	.Grimer_Super
	fishgroup 50 percent + 1, .No_Encounter,	.Fossil_Good,	.Fossil_Super
	fishgroup  5 percent + 1, .No_Encounter,	.IceWater_Good,	.IceWater_Super

.No_Encounter:
; Old Rod is unobtainable
.Shore_Good:
...
TimeFishGroups:
	...
	db GOLDEEN,    20,  GOLDEEN,    20 ; 2 4
	db SEAKING,    45,  SEAKING,    45 ; 3 5
	db POLIWAG,    20,  POLIWAG,    20 ; 4 6
	db POLIWAG,    49,  POLIWAG,    49 ; 5 7
	db DRATINI,    20,  DRATINI,    20 ; 6 8
	db DRATINI,    46,  DRATINI,    46 ; 7 9
	db REMORAID,   15,  REMORAID,   15 ; 8 12
	db GYARADOS,   20,  GYARADOS,   20 ; 9 14
	db DRATINI,    10,  DRATINI,    10 ; 10 16
