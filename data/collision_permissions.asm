...
; entries correspond to COLL_* constants
	...
	NONTALKABLE  WALLTILE ; COLL_GEYSER
	...
	NONTALKABLE  LANDTILE ; COLL_GRASS_4B
	   TALKABLE  LANDTILE ; COLL_SMASH_WALL
	...
	NONTALKABLE  LANDTILE ; COLL_ESCALATOR_DOWN
	NONTALKABLE  LANDTILE ; COLL_ESCALATOR_UP
	NONTALKABLE  LANDTILE ; 66
	NONTALKABLE  LANDTILE ; 67
	NONTALKABLE  LANDTILE ; COLL_BUTTON
	...
	NONTALKABLE  LANDTILE ; COLL_TERMINAL
	...
	NONTALKABLE  WALLTILE ; COLL_GYM_DOOR
	NONTALKABLE  LANDTILE ; COLL_STAIRCASE
	NONTALKABLE  LANDTILE ; COLL_CAVE
	NONTALKABLE  LANDTILE ; COLL_WARP_PANEL
	NONTALKABLE  LANDTILE ; COLL_DOOR_SHIP
	NONTALKABLE  LANDTILE ; COLL_WARP_CARPET_RIGHT
	   TALKABLE  WALLTILE ; COLL_FOUNTAIN
	NONTALKABLE  LANDTILE ; COLL_BOUNCE_PAD_UP
	NONTALKABLE  LANDTILE ; COLL_BOUNCE_PAD_DOWN
	NONTALKABLE  LANDTILE ; COLL_BOUNCE_PAD_LEFT
	NONTALKABLE  LANDTILE ; COLL_BOUNCE_PAD_RIGHT
	...
	NONTALKABLE  WALLTILE ; COLL_CAPSULE_MACHINE
	...
	NONTALKABLE  LANDTILE ; COLL_SNASH_WALL
	NONTALKABLE  LANDTILE ; COLL_SMASH_WALL_B5
	   TALKABLE  WALLTILE ; COLL_UNOWN
	   TALKABLE  WALLTILE ; COLL_OLD_STATUE
	   TALKABLE  WALLTILE ; COLL_UNOWN_X
	NONTALKABLE  WALLTILE ; COLL_STOLEN_ITEMS
	NONTALKABLE  WALLTILE ; COLL_TURNTABLE
	NONTALKABLE  WALLTILE ; COLL_TUBE
	NONTALKABLE  WALLTILE ; COLL_EMPTY_TUBE
