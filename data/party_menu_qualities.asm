...
.TMHM:     partymenuqualities NICKNAMES, TMHM_COMPAT,       STATUS, LEVEL_ALT
.EvoStone: partymenuqualities NICKNAMES, EVO_STONE_COMPAT,  STATUS, LEVEL_ALT
.Gender:   partymenuqualities NICKNAMES, GENDER,            STATUS, LEVEL_ALT
