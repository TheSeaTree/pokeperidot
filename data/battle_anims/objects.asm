...
; entries correspond to ANIM_OBJ_* constants
	...
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_0E, BATTLEANIMFUNC_04, PAL_BATTLE_OB_BLUE, ANIM_GFX_FIRE ; ANIM_OBJ_DRAGON_RAGE
	...
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_11, BATTLEANIMFUNC_02, PAL_BATTLE_OB_BLUE, ANIM_GFX_FIRE ; ANIM_OBJ_DRAGONBREATH
	...
	battleanimobj RELATIVE_X | X_FLIP, $a8, BATTLEANIMFRAMESET_71, BATTLEANIMFUNC_49, PAL_BATTLE_OB_GRAY, ANIM_GFX_PURSUIT ; ANIM_OBJ_PURSUIT
	battleanimobj RELATIVE_X | X_FLIP, $a8, BATTLEANIMFRAMESET_98, BATTLEANIMFUNC_49, PAL_BATTLE_OB_GRAY, ANIM_GFX_PURSUIT ; ANIM_OBJ_GRAB
	...
	battleanimobj RELATIVE_X | X_FLIP, $92, BATTLEANIMFRAMESET_52, BATTLEANIMFUNC_1F, PAL_BATTLE_OB_GRAY, ANIM_GFX_ROPE ; ANIM_OBJ_COIL
	battleanimobj RELATIVE_X, $98, BATTLEANIMFRAMESET_10, BATTLEANIMFUNC_34, PAL_BATTLE_OB_BLUE, ANIM_GFX_FIRE ; ANIM_OBJ_DRAGON_DANCE
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_1A, BATTLEANIMFUNC_13, PAL_BATTLE_OB_GRAY, ANIM_GFX_ROCKS ; ANIM_OBJ_SAFARI_ROCK
	battleanimobj RELATIVE_X, $00, BATTLEANIMFRAMESET_BA, BATTLEANIMFUNC_04, PAL_BATTLE_OB_YELLOW, ANIM_GFX_BAIT ; ANIM_OBJ_SAFARI_BAIT
	battleanimobj RELATIVE_X, $78, BATTLEANIMFRAMESET_10, BATTLEANIMFUNC_POISON_GAS, PAL_BATTLE_OB_BLUE, ANIM_GFX_FIRE ; ANIM_OBJ_WILL_O_WISP
	battleanimobj RELATIVE_X, $78, BATTLEANIMFRAMESET_0F, BATTLEANIMFUNC_POISON_GAS, PAL_BATTLE_OB_BLUE, ANIM_GFX_FIRE ; ANIM_OBJ_WILL_O_WISP_BIG
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_11, BATTLEANIMFUNC_02, PAL_BATTLE_OB_GREEN, ANIM_GFX_ICE ; ANIM_OBJ_SIGNAL_BEAM
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_B9, BATTLEANIMFUNC_07, PAL_BATTLE_OB_RED, ANIM_GFX_CLAW ; ANIM_OBJ_CRAB_CLAW
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_0E, BATTLEANIMFUNC_45, PAL_BATTLE_OB_GRAY, ANIM_GFX_UNOWN ; ANIM_OBJ_HIDDEN_POWER
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_13, BATTLEANIMFUNC_00, PAL_BATTLE_OB_YELLOW, ANIM_GFX_ICE ; ANIM_GFX_BRICK_BREAK
