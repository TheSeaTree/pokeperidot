...
; entries correspond to NPCTRADE_* constants
	npctrade TRADE_DIALOGSET_COLLECTOR, BULBASAUR,  SQUIRTLE,   "CABBAGE@@@@", $37, $66, GOLD_BERRY,   37460, "MIKEY@@@@@@", TRADE_GENDER_EITHER
	npctrade TRADE_DIALOGSET_COLLECTOR, CHARMELEON, BULBASAUR,  "ROCKY@@@@@@", $96, $66, BITTER_BERRY, 48926, "DONNIE@@@@@", TRADE_GENDER_EITHER
	npctrade TRADE_DIALOGSET_COLLECTOR, SQUIRTLE,   CHARMANDER, "VOLTY@@@@@@", $98, $88, GOLD_BERRY, 51984, "RAPHAEL@@@@", TRADE_GENDER_EITHER
