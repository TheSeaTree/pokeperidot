...
; entries correspond to NPCTRADE_* constants
	npctrade TRADE_DIALOGSET_COLLECTOR, VENUSAUR,  SQUIRTLE,   "CABBAGE@@@@", $37, $66, GOLD_LEAF,   37460, "MIKEY@@@@@@", TRADE_GENDER_EITHER
	npctrade TRADE_DIALOGSET_COLLECTOR, CHARIZARD, BULBASAUR,  "ROCKY@@@@@@", $96, $66, GOLD_LEAF, 48926, "DONNIE@@@@@", TRADE_GENDER_EITHER
	npctrade TRADE_DIALOGSET_COLLECTOR, BLASTOISE,   CHARMANDER, "VOLTY@@@@@@", $98, $88, GOLD_LEAF, 51984, "RAPHAEL@@@@", TRADE_GENDER_EITHER
