...
MapGroup_Cinnabar:
	...
	map SafariZoneArea5, TILESET_PARK, ROUTE, SAFARI_ZONE, MUSIC_EVOLUTION, TRUE, PALETTE_AUTO, FISHGROUP_NONE
	map SafariZoneArea6, TILESET_PARK, ROUTE, SAFARI_ZONE, MUSIC_EVOLUTION, TRUE, PALETTE_AUTO, FISHGROUP_NONE
