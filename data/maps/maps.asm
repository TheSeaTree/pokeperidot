...
MapGroup_Dungeons:
	...
	map TentacruelsDen, TILESET_CAVE, CAVE, SEA_ROUTE_4, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_OCEAN
...
MapGroup_Acropora:
	...
	map Route24HiddenCave1F, TILESET_CAVE, CAVE, ROUTE_18, MUSIC_MT_MOON, TRUE, PALETTE_DAY, FISHGROUP_POND
	map Route24HiddenCaveB1F, TILESET_CAVE, CAVE, ROUTE_18, MUSIC_MT_MOON, TRUE, PALETTE_DAY, FISHGROUP_POND
	map DugtriosDen, TILESET_CAVE, CAVE, ROUTE_18, MUSIC_MT_MOON, TRUE, PALETTE_DAY, FISHGROUP_POND
	map Route25Gate, TILESET_GATE, GATE, ROUTE_18, MUSIC_ROUTE_12, FALSE, PALETTE_DAY, FISHGROUP_POND
	map AcroporaCave1F, TILESET_CAVE, GYM_CAVE, ACROPORA_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map AcroporaCave2F, TILESET_CAVE, GYM_CAVE, ACROPORA_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map AcroporaCaveB1F, TILESET_CAVE, GYM_CAVE, ACROPORA_CITY, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_Pectinia:
	...
	map PastPectiniaGym, TILESET_TRAIN_STATION, INDOOR, THE_PAST, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_LakeOfRage:
	...
	map Factory2F, TILESET_FACILITY, DUNGEON, VIRIDIAN_FOREST, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_POND
...
MapGroup_Favia:
	...
	map PectiniaArcade, TILESET_GAME_CORNER, INDOOR, PECTINIA_CITY, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Indigo:
	...
	map WilbursRoom, TILESET_POKEMON_LEAGUE, INDOOR, POKEMON_LEAGUE, MUSIC_INDIGO_PLATEAU, TRUE, PALETTE_MORN, FISHGROUP_NONE
	...
	map JosephsRoom, TILESET_CHAMPIONS_ROOM, INDOOR, POKEMON_LEAGUE, MUSIC_INDIGO_PLATEAU, TRUE, PALETTE_MORN, FISHGROUP_NONE
	map EmilysRoom, TILESET_CHAMPIONS_ROOM, INDOOR, POKEMON_LEAGUE, MUSIC_INDIGO_PLATEAU, TRUE, PALETTE_DAY, FISHGROUP_NONE
...
MapGroup_Silver:
	...
	map LostLandCave1F, TILESET_CAVE, CAVE, LOST_LAND, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_FOSSIL
	map LostLandCaveB1F, TILESET_CAVE, CAVE, LOST_LAND, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_FOSSIL
...
MapGroup_Orchid:
	...
	map OrchidGym1F, TILESET_ELITE_FOUR_ROOM, INDOOR, ORCHID_CITY, MUSIC_GYM, TRUE, PALETTE_DARK, FISHGROUP_SHORE
	map OrchidGymB1F, TILESET_ELITE_FOUR_ROOM, INDOOR, ORCHID_CITY, MUSIC_GYM, TRUE, PALETTE_MORN, FISHGROUP_SHORE
	map OrchidGymLeaderRoom, TILESET_ELITE_FOUR_ROOM, INDOOR, ORCHID_CITY, MUSIC_GYM, TRUE, PALETTE_DARK, FISHGROUP_SHORE
	...
	map MoltenPeak1F, TILESET_CAVE, CAVE, MOLTEN_PEAK, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_POND
	map MoltenPeakB1F, TILESET_CAVE, CAVE, MOLTEN_PEAK, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_POND
	map MoltenPeakB2F, TILESET_CAVE, CAVE, MOLTEN_PEAK, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_POND
	...
	map EnteiCave1F, TILESET_CAVE, CAVE, MOLTEN_PEAK, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_POND
	map EnteiCaveB1F, TILESET_CAVE, CAVE, MOLTEN_PEAK, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_POND
...
MapGroup_Saffron:
	...
	map Route23HiddenCave, TILESET_CAVE, CAVE, ROUTE_19, MUSIC_MT_MOON, TRUE, PALETTE_DAY, FISHGROUP_POND
	...
	map BattleSubwayBossTrain, TILESET_BATTLE_TOWER, INDOOR, PECTINIA_CITY, MUSIC_NONE, FALSE, PALETTE_DAY, FISHGROUP_NONE
	...
	map NorthForest, TILESET_FOREST, ROUTE, VIRIDIAN_FOREST, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_POND
