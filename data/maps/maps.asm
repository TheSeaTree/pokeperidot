...
MapGroup_Cinnabar:
	map SafariZoneGate1F, TILESET_GATE, GATE, ROUTE_18, MUSIC_NATIONAL_PARK, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneGate2F, TILESET_GATE, GATE, ROUTE_18, MUSIC_NATIONAL_PARK, TRUE, PALETTE_DAY, FISHGROUP_SHORE
