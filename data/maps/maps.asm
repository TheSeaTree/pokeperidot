...
MapGroup_Indigo:
	...
	map VictoryPort, TILESET_OCEAN, TOWN, VICTORY_ROAD, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map VictoryPortInside, TILESET_PORT, INDOOR, VICTORY_ROAD, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_OCEAN
