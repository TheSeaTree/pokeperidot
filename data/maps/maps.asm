...
MapGroup_Olivine:
	...
	map LugiaLair, TILESET_CAVE, CAVE, SEA_ROUTE_3, MUSIC_RUINS_OF_ALPH_INTERIOR, FALSE, PALETTE_NITE, FISHGROUP_NONE
...
MapGroup_Palerock:
	...
	map UnownChamberVZ, TILESET_RUINS_OF_ALPH, DUNGEON, ILEX_FOREST, MUSIC_RUINS_OF_ALPH_INTERIOR, FALSE, PALETTE_DAY, FISHGROUP_NONE
