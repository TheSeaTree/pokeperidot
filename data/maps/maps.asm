...
MapGroup_Goldenrod:
	...
	map GoldenrodMagnetTrainStation, TILESET_GATE, INDOOR, AZALEA_TOWN, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cianwood:
	...
	map GoldenrodGym, TILESET_LIGHTHOUSE, INDOOR, CIANWOOD_CITY, MUSIC_GYM, TRUE, PALETTE_MORN, FISHGROUP_SHORE
