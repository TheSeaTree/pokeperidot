...
MapGroup_Simulation:
	map SkyWorld1, TILESET_CYBERSPACE, DUNGEON, LOST_LAND, MUSIC_NONE, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SkyWorld2, TILESET_CYBERSPACE, DUNGEON, LOST_LAND, MUSIC_NONE, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SkyWorld3, TILESET_CYBERSPACE, DUNGEON, LOST_LAND, MUSIC_NONE, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map CyberspaceWorld1, TILESET_CYBERSPACE, DUNGEON, LOST_LAND, MUSIC_NONE, FALSE, PALETTE_DARK, FISHGROUP_NONE
	map GraveyardWorld1, TILESET_CYBERSPACE, DUNGEON, LOST_LAND, MUSIC_NONE, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map GraveyardWorld2, TILESET_CYBERSPACE, DUNGEON, LOST_LAND, MUSIC_NONE, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map GraveyardWorld3, TILESET_CYBERSPACE, DUNGEON, LOST_LAND, MUSIC_NONE, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map IceWorld1, TILESET_ICE_PATH, DUNGEON, LOST_LAND, MUSIC_NONE, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map IceWorld2, TILESET_ICE_PATH, DUNGEON, LOST_LAND, MUSIC_NONE, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map IceWorld3, TILESET_ICE_PATH, DUNGEON, LOST_LAND, MUSIC_NONE, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map CastleWorld1, TILESET_CASTLE, DUNGEON, LOST_LAND, MUSIC_NONE, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map LavaWorld1, TILESET_CAVE, DUNGEON, LOST_LAND, MUSIC_NONE, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map LavaWorld2, TILESET_CAVE, DUNGEON, LOST_LAND, MUSIC_NONE, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map ForestWorld1, TILESET_FOREST, DUNGEON, LOST_LAND, MUSIC_NONE, FALSE, PALETTE_NITE, FISHGROUP_NONE
