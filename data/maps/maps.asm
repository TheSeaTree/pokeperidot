...
MapGroup_FastShip:
	...
	map SSMakoB1FCabin, TILESET_LIGHTHOUSE, INDOOR, FAST_SHIP, MUSIC_SS_AQUA, FALSE, PALETTE_DAY, FISHGROUP_OCEAN
	...
	map SSMakoStern, TILESET_PORT, INDOOR, FAST_SHIP, MUSIC_SS_AQUA, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN

MapGroup_Indigo:
	map PokemonLeague, TILESET_BATTLE_TOWER_OUTSIDE, TOWN, INDIGO_PLATEAU, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_AUTO, FISHGROUP_NONE
