...
MapGroup_Dungeons:
	...
	map LostLand, TILESET_LOST_LAND, ROUTE, LOST_LAND, MUSIC_MT_MOON, TRUE, PALETTE_AUTO, FISHGROUP_OCEAN
	...
	map SeaRoute2Cave, TILESET_CAVE, CAVE, SEA_ROUTE_2, MUSIC_ROUTE_3, FALSE, PALETTE_NITE, FISHGROUP_OCEAN
	map SeaRoute2Cave2F, TILESET_CAVE, CAVE, SEA_ROUTE_2, MUSIC_ROUTE_3, FALSE, PALETTE_NITE, FISHGROUP_OCEAN
	map SeaRoute2CaveOutside, TILESET_LOST_LAND, ROUTE, SEA_ROUTE_2, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map SeaRoute2Cave3F, TILESET_CAVE, CAVE, SEA_ROUTE_2, MUSIC_ROUTE_3, FALSE, PALETTE_NITE, FISHGROUP_OCEAN
...
MapGroup_FastShip:
	...
	map FastShip1F, TILESET_LIGHTHOUSE, INDOOR, SEA_ROUTE_2, MUSIC_SS_AQUA, FALSE, PALETTE_DAY, FISHGROUP_OCEAN
	map FastShip1FRooms, TILESET_LIGHTHOUSE, INDOOR, SEA_ROUTE_2, MUSIC_SS_AQUA, FALSE, PALETTE_DAY, FISHGROUP_OCEAN
	map FastShipB1F, TILESET_LIGHTHOUSE, INDOOR, SEA_ROUTE_2, MUSIC_SS_AQUA, FALSE, PALETTE_DAY, FISHGROUP_OCEAN
	map FastShipB1FCabin, TILESET_LIGHTHOUSE, INDOOR, SEA_ROUTE_2, MUSIC_SS_AQUA, FALSE, PALETTE_DAY, FISHGROUP_OCEAN
...
MapGroup_Indigo:
	...
	map OrvillesRoom, TILESET_POKEMON_LEAGUE, INDOOR, INDIGO_PLATEAU, MUSIC_INDIGO_PLATEAU, TRUE, PALETTE_MORN,FISHGROUP_NONE
	map RegansRoom, TILESET_POKEMON_LEAGUE, INDOOR, INDIGO_PLATEAU, MUSIC_INDIGO_PLATEAU, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map BredesRoom, TILESET_POKEMON_LEAGUE, INDOOR, INDIGO_PLATEAU, MUSIC_INDIGO_PLATEAU, TRUE, PALETTE_DAY, FISHGROUP_QWILFISH_NO_SWARM
	map AmbersRoom, TILESET_POKEMON_LEAGUE, INDOOR, INDIGO_PLATEAU, MUSIC_INDIGO_PLATEAU, TRUE, PALETTE_DARK, FISHGROUP_NONE
	map LancesRoom, TILESET_CHAMPIONS_ROOM, INDOOR, INDIGO_PLATEAU, MUSIC_INDIGO_PLATEAU, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map HallOfFame, TILESET_ICE_PATH, INDOOR, INDIGO_PLATEAU, MUSIC_POKEMON_LULLABY, TRUE, PALETTE_DAY, FISHGROUP_NONE
...
MapGroup_Orchid:
	...
	map Route22HiddenCave, TILESET_CAVE, CAVE, ROUTE_18, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_POND
	map EnteiCave1F, TILESET_CAVE, CAVE, ROUTE_18, MUSIC_MT_MOON, TRUE, PALETTE_DARK, FISHGROUP_POND
	map EnteiCaveB1F, TILESET_CAVE, CAVE, ROUTE_18, MUSIC_MT_MOON, TRUE, PALETTE_DARK, FISHGROUP_POND
