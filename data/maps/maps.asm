...
MapGroup_Lavender:
	...
	map Route14Cave1F, TILESET_CAVE, CAVE, ROUTE_14, MUSIC_ROUTE_12, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map Route14CaveB1F, TILESET_CAVE, CAVE, ROUTE_14, MUSIC_ROUTE_12, FALSE, PALETTE_NITE, FISHGROUP_SHORE
