...
MapGroup_FastShip:
	...
	map FastShip1F, TILESET_LIGHTHOUSE, INDOOR, FAST_SHIP, MUSIC_SS_AQUA, FALSE, PALETTE_DAY, FISHGROUP_OCEAN
	map FastShip1FRooms, TILESET_LIGHTHOUSE, INDOOR, FAST_SHIP, MUSIC_SS_AQUA, FALSE, PALETTE_DAY, FISHGROUP_OCEAN
	map FastShipB1F, TILESET_LIGHTHOUSE, INDOOR, FAST_SHIP, MUSIC_SS_AQUA, FALSE, PALETTE_DAY, FISHGROUP_OCEAN
	map FastShipB1FCabin, TILESET_LIGHTHOUSE, INDOOR, FAST_SHIP, MUSIC_SS_AQUA, FALSE, PALETTE_DAY, FISHGROUP_OCEAN
	map FastShip2F, TILESET_LIGHTHOUSE, INDOOR, FAST_SHIP, MUSIC_SS_AQUA, FALSE, PALETTE_DAY, FISHGROUP_OCEAN
	map FastShip2FRooms, TILESET_LIGHTHOUSE, INDOOR, FAST_SHIP, MUSIC_SS_AQUA, FALSE, PALETTE_DAY, FISHGROUP_OCEAN
...
MapGroup_Orchid:
	...
	map Route22Cave1F, TILESET_CAVE, CAVE, MOLTEN_PEAK, MUSIC_MT_MOON, TRUE, PALETTE_DARK, FISHGROUP_POND
	map Route22CaveB1F, TILESET_CAVE, CAVE, MOLTEN_PEAK, MUSIC_MT_MOON, TRUE, PALETTE_DARK, FISHGROUP_POND
	map Route22CaveB2F, TILESET_CAVE, CAVE, MOLTEN_PEAK, MUSIC_MT_MOON, TRUE, PALETTE_DARK, FISHGROUP_POND
	map Route22North, TILESET_VOLCANO, ROUTE, MOLTEN_PEAK, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map Route22South, TILESET_VOLCANO, ROUTE, MOLTEN_PEAK, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map Route22HiddenCave, TILESET_CAVE, CAVE, MOLTEN_PEAK, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_POND
