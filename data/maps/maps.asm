...
MapGroup_Mahogany:
	...
	map MahoganyTown, TILESET_JOHTO_CITY, TOWN, MAHOGANY_TOWN, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_GRIMER
	map PowerPlant1F, TILESET_FACILITY, INDOOR, POWER_PLANT, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_GRIMER
	map PowerPlant2F, TILESET_FACILITY, INDOOR, POWER_PLANT, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_GRIMER
	...
	map MahoganyGate, TILESET_GATE, GATE, MAHOGANY_TOWN, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map MahoganyMagnetTrainStation, TILESET_TRAIN_STATION, INDOOR, MAHOGANY_TOWN, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Lavender:
	map Route12, TILESET_JOHTO, ROUTE, ROUTE_12, MUSIC_ROUTE_12, FALSE, PALETTE_AUTO, FISHGROUP_QWILFISH_NO_SWARM
	map Route12Shelter, TILESET_HOUSE, INDOOR, ROUTE_12, MUSIC_ROUTE_12, FALSE, PALETTE_DAY, FISHGROUP_LAKE
	map Route13, TILESET_JOHTO, ROUTE, ROUTE_13, MUSIC_ROUTE_12, FALSE, PALETTE_AUTO, FISHGROUP_QWILFISH_NO_SWARM
	...
	map Route18, TILESET_JOHTO, ROUTE, ROUTE_18, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
