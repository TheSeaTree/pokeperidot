...
MapGroup_Favia:
	...
	map FaviaHappinessRater, TILESET_TRADITIONAL_HOUSE, INDOOR, FAVIA_TOWN, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map DayCare, TILESET_HOUSE, INDOOR, FAVIA_TOWN, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route1FaviaGate, TILESET_GATE, GATE, ROUTE_1, MUSIC_ROUTE_29, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map FaviaMart, TILESET_MART, INDOOR, FAVIA_TOWN, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Saffron:
	...
	map BattleSubwayPlatform, TILESET_BATTLE_TOWER, INDOOR, PECTINIA_CITY, MUSIC_NONE, FALSE, PALETTE_DAY, FISHGROUP_NONE
