...
MapGroup_Acropora:
	...
	map Route24North, TILESET_JOHTO, ROUTE, ROUTE_20, MUSIC_ROUTE_12, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map Route24South, TILESET_JOHTO, ROUTE, ROUTE_20, MUSIC_ROUTE_12, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map Route25Gate, TILESET_GATE, GATE, ROUTE_20, MUSIC_ROUTE_12, FALSE, PALETTE_DAY, FISHGROUP_POND
