...
MapGroup_Mahogany:
	...
	map MahoganyTown, TILESET_JOHTO_CITY, TOWN, MAHOGANY_TOWN, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Azalea:
	...
	map PowerPlant1F, TILESET_FACILITY, INDOOR, MAHOGANY_TOWN, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_GRIMER
	map PowerPlant2F, TILESET_FACILITY, INDOOR, MAHOGANY_TOWN, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_GRIMER
	map PowerPlant1FB, TILESET_FACILITY, INDOOR, MAHOGANY_TOWN, MUSIC_UNION_CAVE, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map PowerPlant2FB, TILESET_FACILITY, INDOOR, MAHOGANY_TOWN, MUSIC_UNION_CAVE, TRUE, PALETTE_DAY, FISHGROUP_NONE
