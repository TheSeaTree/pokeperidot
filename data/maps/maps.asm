...
MapGroup_LakeOfRage:
	...
	map Factory1F, TILESET_FACILITY, DUNGEON, ROUTE_4, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_POND
	map FactoryB1, TILESET_FACILITY, DUNGEON, ROUTE_4, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_POND
	map FactoryBack, TILESET_FACILITY, DUNGEON, ROUTE_4, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_POND
	map RaikouLair, TILESET_FACILITY, INDOOR, ROUTE_4, MUSIC_RUINS_OF_ALPH_INTERIOR, TRUE, PALETTE_NITE, FISHGROUP_POND
...
MapGroup_Viridian:
	...
	map BlackthornGym1F, TILESET_CAVE, INDOOR, ORCHID_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route22Cave1F, TILESET_CAVE, CAVE, ORCHID_CITY, MUSIC_MT_MOON, TRUE, PALETTE_DARK, FISHGROUP_POND
	map Route22CaveB1F, TILESET_CAVE, CAVE, ORCHID_CITY, MUSIC_MT_MOON, TRUE, PALETTE_DARK, FISHGROUP_POND
	map Route22CaveB2F, TILESET_CAVE, CAVE, ORCHID_CITY, MUSIC_MT_MOON, TRUE, PALETTE_DARK, FISHGROUP_POND
	map Route22North, TILESET_VOLCANO, ROUTE, ORCHID_CITY, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map Route22South, TILESET_VOLCANO, ROUTE, ORCHID_CITY, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_NONE
