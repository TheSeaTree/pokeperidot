...
MapGroup_Ocean:
	map RugosaCoast, TILESET_JOHTO, TOWN, RUGOSA_COAST, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Rugosa:
	...
	map RugosaCity, TILESET_JOHTO_CITY, TOWN, RUGOSA_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_AUTO, FISHGROUP_GRIMER
	...
	map PowerPlant1FB, TILESET_FACILITY, INDOOR, RUGOSA_CITY, MUSIC_VIRIDIAN_CITY, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map PowerPlant2FB, TILESET_FACILITY, INDOOR, RUGOSA_CITY, MUSIC_VIRIDIAN_CITY, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map RugosaGate, TILESET_GATE, GATE, RUGOSA_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map RugosaEmysHouse, TILESET_HOUSE, INDOOR, RUGOSA_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map MoveDeletersHouse, TILESET_HOUSE, INDOOR, RUGOSA_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map RugosaSubstituteHouse, TILESET_HOUSE, INDOOR, RUGOSA_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map RugosaApartment1F, TILESET_MANSION, INDOOR, RUGOSA_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map RugosaApartment2F, TILESET_MANSION, INDOOR, RUGOSA_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map RugosaApartment3F, TILESET_MANSION, INDOOR, RUGOSA_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map RugosaCafe, TILESET_MART, INDOOR, RUGOSA_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Pewter:
	map RugosaDeptStoreRoof, TILESET_ROOF, TOWN, RUGOSA_CITY, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Celadon:
	...
	map HoOhCastle1FCentralRoom, TILESET_CASTLE, DUNGEON, SPECIAL_MAP, MUSIC_LIGHTHOUSE, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map HoOhCastle1FSideRooms, TILESET_CASTLE, DUNGEON, SPECIAL_MAP, MUSIC_LIGHTHOUSE, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map HoOhCastle2F, TILESET_CASTLE, DUNGEON, SPECIAL_MAP, MUSIC_LIGHTHOUSE, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map HoOhCastle3F, TILESET_CASTLE, DUNGEON, SPECIAL_MAP, MUSIC_LIGHTHOUSE, FALSE, PALETTE_DAY, FISHGROUP_NONE
