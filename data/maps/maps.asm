...
MapGroup_Viridian:
	...
	map EnteiCave1F, TILESET_CAVE, CAVE, ORCHID_CITY, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_POND
	map EnteiCaveB1F, TILESET_CAVE, CAVE, ORCHID_CITY, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_POND
	map EnteiLair, TILESET_CAVE, CAVE, ORCHID_CITY, MUSIC_RUINS_OF_ALPH_INTERIOR, TRUE, PALETTE_DAY, FISHGROUP_POND
	map Route22, TILESET_MOUNTAIN, ROUTE, ROUTE_22, MUSIC_VERMILION_CITY, FALSE, PALETTE_AUTO, FISHGROUP_NONE
