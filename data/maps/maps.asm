...
MapGroup_Cinnabar:
	map SafariZoneGate1F, TILESET_GATE, GATE, CARNATION_TOWN, MUSIC_NATIONAL_PARK, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneGate2F, TILESET_GATE, GATE, CARNATION_TOWN, MUSIC_NATIONAL_PARK, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map CarnationZoo, TILESET_JOHTO_CITY, ROUTE, CARNATION_ZOO, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_AUTO, FISHGROUP_POND
