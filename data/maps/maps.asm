...
MapGroup_Olivine:
	...
	map Route14OlivineGate, TILESET_GATE, GATE, ROUTE_13, MUSIC_ROUTE_12, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OlivineSurfHouse, TILESET_TRADITIONAL_HOUSE, INDOOR, OLIVINE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CoastalLab, TILESET_LAB, INDOOR, OLIVINE_CITY, MUSIC_PROF_ELM, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OlivinePort, TILESET_PORT, INDOOR, OLIVINE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SeaRoute4, TILESET_JOHTO, ROUTE, SEA_ROUTE_4, MUSIC_ROUTE_12, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map Route8, TILESET_JOHTO, ROUTE, ROUTE_7, MUSIC_ROUTE_12, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map SeaRoute1, TILESET_JOHTO, ROUTE, SEA_ROUTE_1, MUSIC_ROUTE_12, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map SeaRoute2, TILESET_JOHTO, ROUTE, SEA_ROUTE_2, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map SeaRoute3, TILESET_JOHTO, ROUTE, SEA_ROUTE_3, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map SeaRoute5, TILESET_JOHTO, ROUTE, SEA_ROUTE_5, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map SeaRoute6, TILESET_JOHTO, ROUTE, SEA_ROUTE_6, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_NONE
...
MapGroup_Mahogany:
	...
	map MahoganyCafe, TILESET_MART, INDOOR, MAHOGANY_TOWN, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Dungeons:
	...
	map PalerockCaveB2F, TILESET_CAVE, CAVE, ROUTE_3, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	...
	map NevermelticeChamber, TILESET_CAVE, CAVE, CIANWOOD_CITY, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_Ecruteak:
	...
	map Route12EcruteakGate, TILESET_GATE, GATE, ROUTE_11, MUSIC_ROUTE_12, FALSE, PALETTE_DAY, FISHGROUP_NONE
	...
	map EmilysHouse1F, TILESET_PLAYERS_HOUSE, INDOOR, ECRUTEAK_CITY, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map EmilysHouse2F, TILESET_PLAYERS_ROOM, INDOOR, ECRUTEAK_CITY, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Blackthorn:
	...
	map Route21, TILESET_JOHTO, TOWN, ROUTE_17, MUSIC_AZALEA_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map Route21EcruteakGate, TILESET_GATE, GATE, ROUTE_17, MUSIC_ROUTE_12, FALSE, PALETTE_DAY, FISHGROUP_NONE
...
MapGroup_Cerulean:
	...
	map CarnationZooGate, TILESET_GATE, GATE, CARNATION_TOWN, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
...
MapGroup_Violet:
	...
	map VioletCafe, TILESET_MART, INDOOR, VIOLET_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map VioletMagikarpHouse, TILESET_HOUSE, INDOOR, VIOLET_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Goldenrod:
	...
	map CarnationFlowerShop, TILESET_HOUSE, INDOOR, CARNATION_TOWN, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route8GoldenrodGate, TILESET_GATE, GATE, ROUTE_7, MUSIC_ROUTE_12, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route11GoldenrodGate, TILESET_GATE, GATE, ROUTE_10, MUSIC_ROUTE_12, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route11Route12Gate, TILESET_GATE, GATE, ROUTE_10, MUSIC_ROUTE_12, FALSE, PALETTE_DAY, FISHGROUP_SHORE

MapGroup_Vermilion:
	map MahoganyDeptStore1F, TILESET_MART, INDOOR, MAHOGANY_TOWN, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map MahoganyDeptStore2F, TILESET_MART, INDOOR, MAHOGANY_TOWN, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map MahoganyDeptStore3F, TILESET_MART, INDOOR, MAHOGANY_TOWN, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map MahoganyDeptStore4F, TILESET_MART, INDOOR, MAHOGANY_TOWN, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map MahoganyDeptStore5F, TILESET_MART, INDOOR, MAHOGANY_TOWN, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map MahoganyDeptStore6F, TILESET_MART, INDOOR, MAHOGANY_TOWN, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map MahoganyDeptStoreElevator, TILESET_MART, INDOOR, MAHOGANY_TOWN, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Pewter:
	map MahoganyDeptStoreRoof, TILESET_ROOF, TOWN, MAHOGANY_TOWN, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Lavender:
	...
	map Route14Cave1F, TILESET_CAVE, CAVE, ROUTE_13, MUSIC_MT_MOON, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map Route14Cave2F, TILESET_CAVE, CAVE, ROUTE_13, MUSIC_MT_MOON, FALSE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_Cianwood:
	...
	map ManiasHouse, TILESET_HOUSE, INDOOR, CIANWOOD_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CianwoodPokecenter1F, TILESET_POKECENTER, INDOOR, CIANWOOD_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CianwoodMart, TILESET_MART, INDOOR, CIANWOOD_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CianwoodPhotoStudio, TILESET_HOUSE, INDOOR, CIANWOOD_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CianwoodLugiaSpeechHouse, TILESET_HOUSE, INDOOR, CIANWOOD_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PokeSeersHouse, TILESET_HOUSE, INDOOR, CIANWOOD_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Viridian:
	...
	map Route22Cave1F, TILESET_CAVE, CAVE, ROUTE_18, MUSIC_MT_MOON, TRUE, PALETTE_DARK, FISHGROUP_POND
	map Route22CaveB1F, TILESET_CAVE, CAVE, ROUTE_18, MUSIC_MT_MOON, TRUE, PALETTE_DARK, FISHGROUP_POND
	map Route22CaveB2F, TILESET_CAVE, CAVE, ROUTE_18, MUSIC_MT_MOON, TRUE, PALETTE_DARK, FISHGROUP_POND
	map Route22North, TILESET_VOLCANO, ROUTE, ROUTE_18, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map Route22South, TILESET_VOLCANO, ROUTE, ROUTE_18, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map Route22HiddenCave, TILESET_CAVE, CAVE, ROUTE_18, MUSIC_MT_MOON, TRUE, PALETTE_DAY, FISHGROUP_POND
...
MapGroup_Saffron:
	...
	map BattleSubwayTrain, TILESET_BATTLE_TOWER, INDOOR, AZALEA_TOWN, MUSIC_NONE, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map BattleSubwayPlatform, TILESET_BATTLE_TOWER, INDOOR, AZALEA_TOWN, MUSIC_NONE, FALSE, PALETTE_DAY, FISHGROUP_NONE
...
MapGroup_Palerock:
	...
	map PalerockMountainB2, TILESET_CAVE, CAVE, ROUTE_3, MUSIC_MT_MOON, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map PalerockMountainB3, TILESET_CAVE, CAVE, ROUTE_3, MUSIC_MT_MOON, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map PalerockMountainWaterfallChamber, TILESET_CAVE, CAVE, ROUTE_3, MUSIC_MT_MOON, FALSE, PALETTE_NITE, FISHGROUP_SHORE
