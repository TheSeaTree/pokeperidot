...
MapGroup_Dungeons:
	...
	map MountMortar1FOutside, TILESET_DARK_CAVE, CAVE, ROUTE_3, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map MountMortar1FInside, TILESET_DARK_CAVE, CAVE, ROUTE_3, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map MountMortar2FInside, TILESET_DARK_CAVE, CAVE, ROUTE_3, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map MountMortarB1F, TILESET_DARK_CAVE, CAVE, ROUTE_3, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	...
	map PalerockCave1F, TILESET_CAVE, CAVE, ROUTE_3, MUSIC_MT_MOON, TRUE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Ecruteak:
	...
	map EcruteakCity, TILESET_JOHTO, TOWN, ECRUTEAK_CITY, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
	map EcruteakForestGate, TILESET_GATE, INDOOR, ECRUTEAK_CITY, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
...
MapGroup_Cerulean:
	...
	map Route9ForestGate, TILESET_GATE, INDOOR, ROUTE_9, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_LAKE

MapGroup_Azalea:
	map Route3, TILESET_MOUNTAIN, ROUTE, ROUTE_3, MUSIC_ROUTE_26, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
	...
	map AzaleaTradeHouse, TILESET_HOUSE, INDOOR, AZALEA_TOWN, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Goldenrod:
	...
	map Route8GoldenrodGate, TILESET_GATE, INDOOR, ROUTE_8, MUSIC_ROUTE_12, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route1GoldenrodGate, TILESET_GATE, INDOOR, ROUTE_1, MUSIC_ROUTE_29, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Silver:
	map SilverCaveOutside, TILESET_KANTO, TOWN, INDIGO_PLATEAU, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_AUTO, FISHGROUP_POND
...
MapGroup_Celadon:
	map Route7Underground, TILESET_GATE, DUNGEON, ROUTE_7, MUSIC_UNION_CAVE, TRUE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cianwood:
	...
	map CianwoodChurch, TILESET_TOWER, INDOOR, CIANWOOD_CITY, MUSIC_BATTLE_TOWER_THEME, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Palerock:
	map PalerockMountain1F, TILESET_CAVE, CAVE, ROUTE_3, MUSIC_MT_MOON, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PalerockMountain2F, TILESET_CAVE, CAVE, ROUTE_3, MUSIC_MT_MOON, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PalerockMountain3F, TILESET_CAVE, CAVE, ROUTE_3, MUSIC_MT_MOON, FALSE, PALETTE_DAY, FISHGROUP_SHORE
