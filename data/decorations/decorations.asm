...
; see constants/deco_constants.asm
	...
	db DECO_DESERTPLANT ; 1d
	db DECO_ISLANDPLANT ; 1e
	db DECO_THIRSTYPLANT ; 1f
	db DECO_TANGELA_POSTER ; 20
	db DECO_SHUCKLE_POSTER ; 20
	db DECO_MYTHIC_POSTER ; 21
	db DECO_DIPLOMA_POSTER ; 21
