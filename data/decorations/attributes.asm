...
; entries correspond to deco constants
	...
	decoration DECO_PLANT,   DESERTPLANT,    SET_UP_PLANT,      EVENT_DECO_PLANT_5,              $29
	...
	decoration DECO_POSTER,  TANGELA,        SET_UP_POSTER,     EVENT_DECO_POSTER_4,             $26
	decoration DECO_POSTER,  SHUCKLE,        SET_UP_POSTER,     EVENT_DECO_POSTER_5,             $27
	decoration DECO_PLANT,   MYTHIC_POSTER,  SET_UP_POSTER,     EVENT_DECO_POSTER_6,             $28
	decoration DECO_PLANT,   DIPLOMA_POSTER, SET_UP_POSTER,     EVENT_DECO_POSTER_7,             $52
	decoration DECO_BED,     CAMO_BED,       SET_UP_BED,        EVENT_DECO_CAMO_BED,             $3a
	decoration DECO_DOLL,    LAPRAS,         SET_UP_DOLL,       EVENT_DECO_LAPRAS_DOLL,		 SPRITE_SURF
	decoration DECO_DOLL,    SNORLAX,        SET_UP_DOLL,       EVENT_DECO_SNORLAX_DOLL,		 SPRITE_SNORLAX
	decoration DECO_DOLL,    SUDOWOODO,      SET_UP_DOLL,       EVENT_DECO_SUDOWOODO_DOLL,		 SPRITE_SUDOWOODO
	decoration DECO_PLANT,   SILVER_TROPHY,  SET_UP_DOLL,       EVENT_DECO_SILVER_TROPHY,        SPRITE_SILVER_TROPHY
	decoration DECO_PLANT,   GOLD_TROPHY,    SET_UP_DOLL,       EVENT_DECO_GOLD_TROPHY,          SPRITE_GOLD_TROPHY
	decoration DECO_PLANT,   PERIDOT_TROPHY, SET_UP_DOLL,       EVENT_DECO_PERIDOT_TROPHY,       SPRITE_PERIDOT_TROPHY
