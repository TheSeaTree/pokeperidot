...
.e:        db SKARMORY, AIPOM, ESPEON, SEARION, ELEKID, ELECTABUZZ, ENTEI, -1
.o:        db FERALIGATR, FURRET, OCTILLERY, PRIMEAPE, SENTRET, STANTLER, SPEAROW, FEAROW, OMASTAR, OMANYTE, -1
.ka_ga:    db GROWLITHE, MACHAMP, DRAGONITE, PINSIR, SNORLAX, KABUTO, KABUTOPS, GREMINI, WARTORTLE, BLASTOISE, FARFETCH_D, CUBONE, MAROWAK, KANGASKHAN, -1
...
.ko_go:    db MAGIKARP, MAGNEMITE, GASTLY, HAUNTER, MACHOKE, KAKUNA, SMOLA, PHANPY, RINRING, ANCOR, GOLBAT, GOLEM, GRAVELER, VENONAT, -1
.sa_za:    db RHYHORN, PUPITAR, CORSOLA, CONCHER, ZAPDOS, JOLTEON, SANDSHREW, SANDSLASH, -1 ; RHYDON should lead this list
...
.to_do:    db DODUO, DODRIO, SMEARGLE, KOFFING, TENTACRUEL, SNOWMAD, SHIFUR, GOLDEEN, METAPOD, DONPHAN, -1
.na:       db ODDISH, EXEGGUTOR, -1
.ni:       db NIDOKING, NIDOQUEEN, NIDORAN_M, NIDORAN_F, NIDORINA, NIDORINO, MEOWTH, TUNGTYED, POLIWHIRL, POLITOED, POLIWRATH, POLIWAG, -1
.nu:       db QUAGSIRE, -1
.ne:       db NATU, XATU, -1
.no:       db DUNSPARCE, -1
.ha_ba_pa: db SEEL, STEELIX, TYPHLOSION, DRAGONAIR, BUTTERFREE, SCIZOR, HOPPIP, BLISSEY, PARAS, PARASECT, QWILFISH, MR__MIME, TANGROWTH, CLOYSTER, TYRANITAR, -1
.hi_bi_pi: db MANDRABEL, WEEDLE, PIKACHU, CLEFABLE, PIDGEOT, PIDGEOTTO, SIRFETCH_D, CLEFAIRY, CHARMANDER, STARYU, CYNDAQUIL, SUNKERN, TEDDIURSA, VOLTORB, -1
...
.ra:       db RAIKOU, RAICHU, CHANSEY, NYANELL, LAPRAS, VILEPLUME, LANTURN, -1
.ri:       db CHARMELEON, CHARIZARD, URSARING, -1
.ru:       db JYNX, LUGIA, -1
.re:       db MAGNETON, ELECTIGER, CUBBOLT, -1
.ro:       db VULPIX, -1
