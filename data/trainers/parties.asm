...
BikerGroup:
	...
	db 40, MUK,			THIEF, GUNK_SHOT, MINIMIZE, SCREECH
	db 40, ELECTABUZZ,  THIEF, THUNDERBOLT, LIGHT_SCREEN, THUNDER_WAVE
	db 41, AIPOM,		THIEF, AGILITY, SWIFT, BATON_PASS
	db -1
	...
	db 41, MISDREAVUS,  THIEF, SHADOW_BALL, PAIN_SPLIT, PSYBEAM 
	db -1
	...
	db 41, MURKROW,		THIEF, ENCORE, SWAGGER, WING_ATTACK
	db -1
