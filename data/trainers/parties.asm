...
JasmineGroup:
	...
	db 30, SANDSLASH,	SMOOTH_ROCK,	EARTHQUAKE, ROCK_SLIDE, SWORDS_DANCE, SPIKES
	db 30, RHYDON,		SOFT_SAND,		EARTHQUAKE, ROCK_SLIDE, COUNTER, SURF
	db 30, KANGASKHAN,	SILK_SCARF,		EARTHQUAKE, ROCK_SLIDE, STRENGTH, CRUNCH
	db 30, NIDOKING,	X_SP_ATK,		EARTHQUAKE, FLAMETHROWER, ICE_BEAM, THUNDERBOLT
	db 30, NIDOQUEEN,	LEFTOVERS,		EARTHQUAKE, ROCK_SMASH, CRUNCH, SLUDGE_BOMB
	db 30, STEELIX,		SILVER_BERRY,	EARTHQUAKE, IRON_TAIL, COIL, SUBSTITUTE
	db -1 ; end

ChuckGroup:
	; CHUCK (1)
	db "CHUCK@", TRAINERTYPE_ITEM_MOVES
	db 33, MAGNETON,  	X_SPEED,		THUNDERBOLT, REFLECT, LIGHT_SCREEN, EXPLOSION
...
ErikaGroup:
	...
	db 33, BUTTERFREE,	X_ACCURACY,	PSYBEAM, SOLARBEAM, SLEEP_POWDER, QUIVER_DANCE
	db 34, EXEGGUTOR, 	LEFTOVERS,	PSYCHIC_M, SOLARBEAM, STUN_SPORE, LEECH_SEED
	db 34, PINSIR,    	X_ATTACK,	BUG_BUZZ, ROCK_SMASH, DIG, SUBMISSION
	db 33, TANGROWTH, 	LEFTOVERS,	ANCIENTPOWER, GIGA_DRAIN, STUN_SPORE, LEECH_SEED
	db 37, VENUSAUR,	X_SP_DEF,  	GIGA_DRAIN, LEECH_SEED, SYNTHESIS, SOLARBEAM
	db -1 ; end
...
BeautyGroup:
	...
	db 35, MILTANK,		SURF, STRENGTH, MILK_DRINK, NO_MOVE
	db -1
	
	; BEAUTY (7)
	db "MARIE@", TRAINERTYPE_MOVES
	db 35, AMPHAROS,	THUNDERPUNCH, CONFUSE_RAY, DOUBLE_EDGE, THUNDER_WAVE
	db 35, PONYTA,		FLAME_WHEEL, HEADBUTT, NO_MOVE, NO_MOVE
	db 35, TAUROS,		DOUBLE_EDGE, BITE, REST, HEADBUTT
	db 35, MILTANK,		SURF, STRENGTH, MILK_DRINK, NO_MOVE
	db -1
