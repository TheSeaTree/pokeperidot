...
JasmineGroup:
	...
	db 42, SANDSLASH,	SMOOTH_ROCK,	EARTHQUAKE, ROCK_SLIDE, SWORDS_DANCE, SPIKES
	...
	; JASMINE (1)
	db "JASMINE@", TRAINERTYPE_ITEM_MOVES
	db 70, SANDSLASH,	SMOOTH_ROCK,	EARTHQUAKE, ROCK_SLIDE, SWORDS_DANCE, SPIKES
...
ClairGroup:
	...
	db 46, MAGMAR,		HEAT_ROCK,		FLAMETHROWER, THUNDERBOLT, EARTHQUAKE, SUNNY_DAY
	db 45, DRAGONAIR,	X_SPEED,		FLAMETHROWER, DRAGONBREATH, THUNDER_WAVE, ICE_BEAM
	db 46, TYPHLOSION,	HEAT_ROCK,		FLAMETHROWER, THUNDERPUNCH, SOLARBEAM, SUNNY_DAY
	db 45, DRAGONAIR,	X_SPEED,		FLAMETHROWER, DRAGONBREATH, THUNDER_WAVE, ICE_BEAM
	...
	db 70, MAGMAR,		HEAT_ROCK,		FLAMETHROWER, THUNDERBOLT, EARTHQUAKE, SUNNY_DAY
	db 70, DRAGONITE,	X_SPEED,		FLAMETHROWER, DRAGONBREATH, THUNDER_WAVE, ICE_BEAM
	db 70, TYPHLOSION,	HEAT_ROCK,		FLAMETHROWER, THUNDERPUNCH, SOLARBEAM, SUNNY_DAY
	db 70, DRAGONITE,	X_SPEED,		FLAMETHROWER, DRAGONBREATH, THUNDER_WAVE, ICE_BEAM
...
PoseyGroup:
	...
	; POSEY (3)
	db "POSEY@", TRAINERTYPE_ITEM_MOVES
	db 70, BELLOSSOM,	HEAT_ROCK,	MOONLIGHT, SOLARBEAM, STUN_SPORE, GIGA_DRAIN
