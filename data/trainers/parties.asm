...
PryceGroup:
	...
	db 27, TANGELA,   SLEEP_POWDER, GIGA_DRAIN, POISONPOWDER, LEECH_SEED
	db 29, PINSIR,    BUG_BUZZ, ROCK_SMASH, DIG, SOLARBEAM
	db 32, VENUSAUR,  GIGA_DRAIN, LEECH_SEED, POISONPOWDER, SOLARBEAM
	db -1 ; end
