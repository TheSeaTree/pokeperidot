...
Rival1Group:
	...
	db "MIKE@", TRAINERTYPE_ITEM_MOVES
	db 39, PRIMEAPE,	BLACKGLASSES,		CROSS_CHOP, SCREECH, SWAGGER, PURSUIT
...
BurglarGroup:
	...
	db 41, PRIMEAPE,	THIEF, SUBMISSION, SCREECH, SWAGGER
...
ExecutiveMGroup:
	...
	; FATHER (2)
	db "ABBOT@", TRAINERTYPE_MOVES
	db 40, ALAKAZAM,	CONFUSION, DISABLE, THIEF, TELEPORT
	db 40, HYPNO,		CALM_MIND, PSYBEAM, THIEF, DISABLE
	db 40, GENGAR,		CONFUSE_RAY, LICK, THIEF, NIGHT_SHADE
	db 42, GREMINI,		PURSUIT, CONFUSE_RAY, THIEF, DOUBLE_TEAM
	db -1
