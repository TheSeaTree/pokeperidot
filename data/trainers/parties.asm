...
MortyGroup:
	...
	db 22, NYANELL,   FAINT_ATTACK, FURY_SWIPES, GROWL, SWAGGER
	db 25, MURKROW,   NIGHT_SHADE, THIEF, WING_ATTACK, SWAGGER
	db 24, HAUNTER,	  CONFUSE_RAY, CURSE, NIGHT_SHADE, SWAGGER
	db 25, HOUNDOOM,  BITE, SMOG, FLAME_WHEEL, SWAGGER
	db -1 ; end
...
HikerGroup:
	...
	db 20, MACHOP,	ROCK_SMASH, LEER, THIEF, SEISMIC_TOSS
	db 21, GEODUDE, ROCK_SMASH, DEFENSE_CURL, ROLLOUT, BULLDOZE
	db -1 ; end
...
BlackbeltGroup:
	...
	db 21, MANKEY,	ROCK_SMASH, FOCUS_ENERGY, FURY_SWIPES, KARATE_CHOP
	db 22, HERACROSS, ROCK_SMASH, HORN_ATTACK, LEER, ENDURE
	db -1 ; end
