...
ClairGroup:
	...
	db 45, DRAGONAIR,	X_SPEED,		FLAMETHROWER, DRAGONBREATH, THUNDER_WAVE, ICE_BEAM
	db 50, CHARIZARD,	X_ATTACK,		FLAMETHROWER, FLY, DRAGONBREATH, EARTHQUAKE
	db -1 ; end
	...
	db 70, DRAGONITE,	X_SPEED,		FLAMETHROWER, DRAGONBREATH, THUNDER_WAVE, ICE_BEAM
	db 70, CHARIZARD,	X_ATTACK,		FLAMETHROWER, FLY, DRAGONBREATH, EARTHQUAKE
	db -1 ; end
...
PoseyGroup:
	...
	db 70, VENUSAUR,	X_SP_DEF,  	BODY_SLAM, LEECH_SEED, SYNTHESIS, SOLARBEAM
	db -1 ; end
