...
ClairGroup:
	...
	db 37, ARCANINE,	FLAMETHROWER, SUNNY_DAY, SOLARBEAM, PLAY_ROUGH
	db 37, MAGMAR,		FLAMETHROWER, THUNDERBOLT, EARTHQUAKE, SUNNY_DAY
	db 37, DRAGONAIR,	FLAMETHROWER, DRAGONBREATH, THUNDER_WAVE, ICE_BEAM
	db 37, TYPHLOSION,	FLAMETHROWER, THUNDERPUNCH, SOLARBEAM, SUNNY_DAY
	db 37, DRAGONAIR,	FLAMETHROWER, DRAGONBREATH, THUNDER_WAVE, ICE_BEAM
	db 37, CHARIZARD,	FLAMETHROWER, FLY, DRAGONBREATH, EARTHQUAKE
	db -1 ; end
