...
MortyGroup:
	...
	db 70, MURKROW,   	SHARP_BEAK,	  SKY_ATTACK, MIRROR_MOVE, FAINT_ATTACK, SUBMISSION
...
JoelGroup:
	...
	db 70, SKARMORY, 	X_ATTACK,		SKY_ATTACK, IRON_HEAD, SPIKES, WHIRLWIND
...
WillGroup:
	...
	db 54, SKARMORY,	X_SPEED,		SWORDS_DANCE, SKY_ATTACK, STEEL_WING, WHIRLWIND
	...
	db 54, CROBAT,		POISON_BARB,	SLUDGE_BOMB, SKY_ATTACK, LEECH_LIFE, CONFUSE_RAY
	db -1 ; end
