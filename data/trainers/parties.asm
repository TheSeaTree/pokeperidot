...
PryceGroup:
	...
	db 31, PINSIR,    BUG_BUZZ, ROCK_SMASH, DIG, ROCK_SMASH
...
ChuckGroup:
	...
	db 27, MAGNETON,  	X_SPEED,		THUNDERBOLT, REFLECT, LIGHT_SCREEN, EXPLOSION
	db 30, ELECTABUZZ,	MAGNET,			THUNDERBOLT, FLAMETHROWER, ICE_PUNCH, SUBMISSION
	db 30, SKARMORY, 	X_SPEED,		SKY_ATTACK, IRON_HEAD, SPIKES, WHIRLWIND
	db 30, STEELIX,		LEFTOVERS,		BULLDOZE, IRON_TAIL, COIL, ROAR
	db 30, LANTURN,		LEFTOVERS,		THUNDERBOLT, SURF, REST, SLEEP_TALK
	db 30, RAICHU,		LIGHT_BALL,		THUNDERBOLT, ICE_PUNCH, SURF, PLAY_ROUGH
	db -1 ; end
...
Rival1Group:
	...
	db 32, AZUMARILL,	NO_ITEM,			PLAY_ROUGH, WATERFALL, ROLLOUT, DEFENSE_CURL
	db 30, ARCANINE,	NO_ITEM,			FLAME_WHEEL, DOUBLE_EDGE, BITE, ROAR
	db 34, NIDOKING,	NO_ITEM,			ROCK_SMASH, STRENGTH, DIG, POISON_STING
	db 35, MEGANIUM,	MIRACLEBERRY,		MEGA_DRAIN, REFLECT, SYNTHESIS, POISONPOWDER
	db -1 ; end
	...
	db 30, ELECTABUZZ,	BLACKBELT,			THUNDERPUNCH, LOW_KICK, THUNDER_WAVE, LIGHT_SCREEN
	db 32, URSARING,	MINT_BERRY,			HEADBUTT, FAINT_ATTACK, REST, ROCK_SMASH
	db 32, TANGELA,		NO_ITEM,			STUN_SPORE, MEGA_DRAIN, GROWTH, SLEEP_POWDER
	db 30, AZUMARILL,	NO_ITEM,			PLAY_ROUGH, WATERFALL, ROLLOUT, DEFENSE_CURL
	db 34, NIDOKING,	NO_ITEM,			ROCK_SMASH, STRENGTH, DIG, POISON_STING
	db 35, TYPHLOSION,	MIRACLEBERRY,		FLAME_WHEEL, SMOKESCREEN, QUICK_ATTACK, DEFENSE_CURL
	db -1 ; end
	...
	db 30, ELECTABUZZ,	BLACKBELT,			THUNDERPUNCH, LOW_KICK, THUNDER_WAVE, LIGHT_SCREEN
	db 32, URSARING,	MINT_BERRY,			HEADBUTT, FAINT_ATTACK, REST, ROCK_SMASH		
	db 32, ARCANINE,	NO_ITEM,			FLAME_WHEEL, DOUBLE_EDGE, BITE, ROAR
	db 30, TANGELA,		NO_ITEM,			STUN_SPORE, MEGA_DRAIN, GROWTH, SLEEP_POWDER
	db 34, NIDOKING,	NO_ITEM,			ROCK_SMASH, STRENGTH, DIG, POISON_STING
	db 35, FERALIGATR,	MIRACLEBERRY,		ICE_PUNCH, CRUNCH, WATER_GUN, LEER
	db -1 ; end
...
CamperGroup:
	...
	db 31, BUTTERFREE,		QUIVER_DANCE, PSYBEAM, STRUGGLE_BUG, SUPERSONIC
