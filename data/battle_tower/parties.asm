...
BattleTowerMons1:
	...
	db AERODACTYL
	db FOCUS_SASH
	db STONE_EDGE, DIVE_BOMB, EARTHQUAKE, HYPER_BEAM
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db SNORLAX
	db LEFTOVERS
	db BODY_SLAM, SLEEP_TALK, REST, CRUNCH
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
...
BattleTowerMons3:
	...
	db DUGTRIO
	db KINGS_ROCK
	db EARTHQUAKE, SLUDGE_BOMB, CUT, MUD_SLAP
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
...
BattleTowerMons4:
	...
	db GOLEM
	db FOCUS_BAND
	db EXPLOSION, EARTHQUAKE, BODY_SLAM, ROCK_SLIDE
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db SCIZOR
	db SCOPE_LENS
	db CUT, STEEL_WING, PURSUIT, HYPER_BEAM
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db CHARIZARD
	db KINGS_ROCK
	db FIRE_SPIN, DRAGON_RAGE, FLY, CUT
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db EXEGGUTOR
	db BRIGHTPOWDER
	db EGG_BOMB, HEADBUTT, PSYCH_UP, CONFUSION
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
