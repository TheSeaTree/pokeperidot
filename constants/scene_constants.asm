...
; wRoute19SceneID
	const_def
	const SCENE_ROUTE19_NOTHING     ; 0
	const SCENE_ROUTE19_MISTYS_DATE ; 1
...
; wRoute14FarmhouseSceneID
	const_def
	const SCENE_ROUTE14FARMHOUSE_DEFAULT
	const SCENE_ROUTE14FARMHOUSE_FINISHED
...
; wBattleSimulationSceneID
	...
	const SCENE_BATTLESIMULATION_RETURNED_TO_PRESENT
	const SCENE_BATTLESIMULATION_CLEAR_TEMP_EVENT
...
; wMewIslandInsideSceneID
	const_def
	const SCENE_GENESIS_ISLAND_INTRO
	const SCENE_GENESIS_ISLAND_SPOT_1
	const SCENE_GENESIS_ISLAND_SPOT_2
	const SCENE_GENESIS_ISLAND_SPOT_3
	const SCENE_GENESIS_ISLAND_SPOT_4
	const SCENE_GENESIS_ISLAND_SPOT_5
	const SCENE_GENESIS_ISLAND_NOTHING
