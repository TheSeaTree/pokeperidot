...
; wFastShip1FSceneID
	const_def
	const SCENE_FASTSHIP1F_DEFAULT
	const SCENE_FASTSHIP1F_FOLLOWING
	const SCENE_FASTSHIP1F_FINISHED
	
; wFastShip1FRoomsSceneID
	const_def
	const SCENE_FASTSHIP1FROOMS_DEFAULT
	const SCENE_FASTSHIP1FROOMS_FOLLOWING
	const SCENE_FASTSHIP1FROOMS_FINISHED
	
; wFastShipB1FSceneID
	const_def
	const SCENE_FASTSHIPB1F_DEFAULT
	const SCENE_FASTSHIPB1F_FOLLOWING
	const SCENE_FASTSHIPB1F_FINISHED

; wFastShipB1FCabinSceneID
	const_def
	const SCENE_FASTSHIPB1FCABIN_DEFAULT
	const SCENE_FASTSHIPB1FCABIN_FOLLOWING
	const SCENE_FASTSHIPB1FCABIN_FINISHED
	
; wFastShip2FSceneID
	const_def
	const SCENE_FASTSHIP2F_DEFAULT
	const SCENE_FASTSHIP2F_FOLLOWING
	const SCENE_FASTSHIP2F_FINISHED

; wFastShip2FRoomsSceneID
	const_def
	const SCENE_FASTSHIP2FROOMS_DEFAULT
	const SCENE_FASTSHIP2FROOMS_FOLLOWING
	const SCENE_FASTSHIP2FROOMS_FINISHED
