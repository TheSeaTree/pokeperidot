; MoveEffectsPointers indexes (see data/moves/effects_pointers.asm)
	...
	const EFFECT_BURN_RECOIL_HIT
	const EFFECT_PARA_RECOIL_HIT
	const EFFECT_HURRICANE
	const EFFECT_COIL
	const EFFECT_GROWTH
	const EFFECT_SLEEP_POWDER
	const EFFECT_POISONPOWDER
	const EFFECT_STUN_SPORE
	const EFFECT_U_TURN
	const EFFECT_BURN
	const EFFECT_EXTREMESPEED
	const EFFECT_HYPER_BEAM_RECHARGE
