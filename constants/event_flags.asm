...
;TM/HM flags
	...
	const EVENT_GOT_TM_FLAMETHROWER
	...
	const EVENT_GOT_TM_WHIRLPOOL
	const EVENT_GOT_TM_SWAGGER
...
; Johto people
	...
	const EVENT_ROUTE_14_CAVE_B1F_BOULDER_1
	const EVENT_ROUTE_14_CAVE_B1F_BOULDER_2
	const EVENT_ROUTE_14_CAVE_B1F_BOULDER_3
