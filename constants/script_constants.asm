...
; PlayerEventScriptPointers indexes (see engine/overworld/events.asm)
	...
	const PLAYEREVENT_WARP_SILENT
	const PLAYEREVENT_STAIRCASE
...
; FruitTreeItems indexes (see data/items/fruit_trees.asm)
	const_def 1
	const FRUITTREE_ROUTE_18_SOUTH_1   	; 01
	const FRUITTREE_PAVONA_OASIS   		; 02
	const FRUITTREE_ROUTE_18_SOUTH_2   	; 03
	const FRUITTREE_STAGHORN_TOWN 		; 04
	const FRUITTREE_PAVONA_OASIS_2 		; 05
	const FRUITTREE_ORIENTEM_FOREST		; 06
	const FRUITTREE_ROUTE_19      		; 07
	const FRUITTREE_SEA_ROUTE_3   		; 08
	const FRUITTREE_VIOLET_CITY_1 		; 09
	const FRUITTREE_CIANWOOD_CITY 		; 0a
	const FRUITTREE_ROUTE_21      		; 0b
	const FRUITTREE_CARNATION_TOWN		; 0c
	const FRUITTREE_ROUTE_17      		; 0d
	const FRUITTREE_ROUTE_18_NORTH		; 0e
	const FRUITTREE_ROUTE_11_1    		; 0f
	const FRUITTREE_ROUTE_11_2    		; 10
	const FRUITTREE_ROUTE_16_1    		; 11
	const FRUITTREE_ROUTE_16_2    		; 12
	const FRUITTREE_ROUTE_3	      		; 13
	const FRUITTREE_AZALEA_TOWN   		; 14
	const FRUITTREE_MAHOGANY_TOWN 		; 15
	const FRUITTREE_ROUTE_12_1    		; 16
	const FRUITTREE_ROUTE_12_2    		; 17
	const FRUITTREE_ROUTE_10      		; 18
	const FRUITTREE_ROUTE_2_1     		; 19
	const FRUITTREE_ROUTE_1       		; 1a
	const FRUITTREE_ROUTE_7       		; 1b
	const FRUITTREE_VIOLET_CITY_2 		; 1c
	const FRUITTREE_PAINTERS_FOREST 	; 1d
	const FRUITTREE_ROUTE_5       		; 1e
	const FRUITTREE_ROUTE_2_2			; 1f
	const FRUITTREE_OCCIDENT_FOREST   	; 20
