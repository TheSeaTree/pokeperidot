; EngineFlags indexes (see engine/engine_flags.asm)
	const_def
; wPokegearFlags
	const ENGINE_BATTLE_SUBWAY_LEVELS
	const ENGINE_HAVE_BATTLE_PASS
	const ENGINE_LOST_LAND_VISITED
...
; wStatusFlags
	...
	const ENGINE_UNUSED_STATUSFLAG1_1 ; 10
; wStatusFlags2
	const ENGINE_UNUSED_STATUSFLAG2_1
	const ENGINE_UNUSED_STATUSFLAG2_2 ; Unused
	const ENGINE_ROCKETS_IN_RADIO_TOWER
	const ENGINE_BATTLE_SUBWAY_ACTIVE
	const ENGINE_IN_THE_PAST
...
; wVisitedSpawns
	...
	const ENGINE_VISITED_LOST_LAND
...
; wSwarmFlags
	...
	const ENGINE_SAFARI_GAME_ACTIVE
; wGameTimerPause
	const ENGINE_62
; wPlayerGender
