...
AnimObjPursuitGFX:   INCBIN "gfx/battle_anims/pursuit.2bpp.lz"
AnimObjClawGFX:      INCBIN "gfx/battle_anims/claw.2bpp.lz"
AnimObjUnownGFX:     INCBIN "gfx/battle_anims/unown.2bpp.lz"
AnimObjBaitGFX:      INCBIN "gfx/battle_anims/bait.2bpp.lz"
