...
CubboltAnimationIdle:     INCLUDE "gfx/pokemon/cubbolt/anim_idle.asm"
ElectigerAnimationIdle:     INCLUDE "gfx/pokemon/electiger/anim_idle.asm"
...
TungtyedAnimationIdle:   INCLUDE "gfx/pokemon/tungtyed/anim_idle.asm"
