...
CubboltBitmasks:    INCLUDE "gfx/pokemon/cubbolt/bitmask.asm"
ElectigerBitmasks:  INCLUDE "gfx/pokemon/electiger/bitmask.asm"
...
TungtyedBitmasks:   INCLUDE "gfx/pokemon/tungtyed/bitmask.asm"
