	...
	tilepal 1, GRAY, RED, WATER, BROWN, BROWN, BROWN, GRAY, GRAY
	tilepal 1, GRAY, BROWN, GRAY, GRAY, RED, RED, RED, BROWN
	tilepal 1, GRAY, GRAY, WATER, WATER, WATER, RED, BROWN, BROWN
