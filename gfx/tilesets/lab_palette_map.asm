	...
	tilepal 0, GRAY, GRAY, WATER, WATER, WATER, GREEN, GREEN, BROWN
	tilepal 0, BROWN, GRAY, GRAY, GRAY, BROWN, BROWN, ROOF, ROOF
	tilepal 0, GRAY, GRAY, WATER, WATER, WATER, GREEN, GREEN, BROWN
	tilepal 0, BROWN, WATER, WATER, BROWN, BROWN, BROWN, ROOF, TEXT
